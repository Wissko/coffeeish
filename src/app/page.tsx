  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none hero-grain" />
        <div className="absolute inset-0 z-[1] pointer-events-none" style={{background: "radial-gradient(ellipse at center, transparent 30%, rgba(26,26,26,0.75) 80%, rgba(26,26,26,0.95) 100%)"}} />
